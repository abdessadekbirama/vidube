...
function Videos(){
    ...
    return(
        <div>
            <h1 className="text-2xl text-center">Welcome to <span className="bg-gradient-to-r from-[blue] to-[green] bg-clip-text text-transparent text-semibold">Vidube</span></h1>
